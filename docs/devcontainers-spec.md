# Dev Container Specification Reference
...
- [Three Configuration Scenarios](#three-configuration-scenarios)
- [devcontainer.json Properties](#devcontainerjson-properties)
  - [General Properties (All Scenarios)](#general-properties-all-scenarios)
  - [Image / Dockerfile Properties](#image--dockerfile-properties)
...
- [Workspace Mount and Folder](#workspace-mount-and-folder)
- [Image Metadata](#image-metadata)
  - [Metadata Merge Rules](#metadata-merge-rules)
- [Features](#features)
  - [Feature Structure](#feature-structure)
  - [devcontainer-feature.json](#devcontainer-featurejson)
  - [Feature Options](#feature-options)
  - [Built-in Variables for install.sh](#built-in-variables-for-installsh)
  - [Installation Order Algorithm](#installation-order-algorithm)
  - [Feature Equality](#feature-equality)
  - [Dockerfile Layer Generation](#dockerfile-layer-generation)
  - [Feature Lifecycle Hooks](#feature-lifecycle-hooks)
- [Features Distribution (OCI)](#features-distribution-oci)
- [Templates](#templates)
- [devcontainerId Computation](#devcontainerid-computation)
...
*Generated by Claude Opus 4.6 (claude-opus-4-6) on 2026-02-21.*
