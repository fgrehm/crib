...
Auto-discovers other plugins' artifacts (ssh keys, credentials, shell history) and generates deny rules to protect them. Network blocking uses iptables OUTPUT chain rules for RFC 1918 and cloud metadata endpoints.
